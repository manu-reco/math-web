...
export default function IntroduccionRectaContent() {
    const article = findArticleById("introduccion-recta");

    return (
        <>
            <ArticleHeader
                title={article?.title || "Introducción a la plantilla de la Recta Numérica"}
                subtitle={article?.subtitle || "Fomentando el descubrimiento en lugar de la instrucción directa"}
                description="A través de esta actividad, introducimos de manera natural la plantilla de la recta numérica, solo hasta el número 5, utilizando una conversación guiada en el aula y material manipulativo."
                category="Aritmética"
