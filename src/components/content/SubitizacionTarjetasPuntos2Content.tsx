...
export default function SubitizacionTarjetasPuntos2Content() {
    ...
    return (
        <>
            <ArticleHeader
                title={article?.title || "Subitización con Tarjetas de Puntos: Nivel 2"}
                subtitle={article?.subtitle || "Utilizamos tarjetas con puntos para identificar cantidades pequeñas de forma súbita, sin conteo, y asociarlas con números arábigos. Números del 3 al 5."}
            ...
            <ArticleSection title="Juego 1. Nivel 1.">
                <p><strong>Objetivo:</strong> identificar las cantidades 3, 4 y 5, asociándolas con los números arábigos que las representan.</p>
                ...
                <ul className="list-disc list-inside my-4 ml-8 space-y-3">
                    <li>Tarjetas con puntos negros. Las tarjetas tienen tres puntos, cuatro puntos o cinco puntos, colocados de formas distintas, teniendo en cuenta todas las descomposiciones posibles de cada cantidad en dos sumandos. Necesitaremos, al menos, tres tarjetas de cada cantidad en cada lote.</li>
                    <li>Tarjetas con los dígitos 3, 4 y 5.</li>
                </ul>

                <ArticleImages images={[
                    { src: "/subitizacion/juego-puntos-3-5-desorden.jpeg", alt: "Tarjetas con puntos, con cantidades de 3 a 5, y tarjetas con los dígitos 3, 4 y 5" }
                ]} />
            ...
            <ArticleSection title="Dinámica">
                ...
                <ArticleImages images={[
                    { src: "/subitizacion/juego-puntos-3-5-desorden.jpeg", alt: "Tarjetas con puntos, con cantidades de 3 a 5, y tarjetas con los dígitos 3, 4 y 5" },
                    { src: "/subitizacion/juego-puntos-3-5-orden.jpeg", alt: "Juego de tarjetas con puntos con cantidades del 3 al 5, para agrupar bajo tarjetas con los dígitos 3, 4 y 5" }
                ]} />
