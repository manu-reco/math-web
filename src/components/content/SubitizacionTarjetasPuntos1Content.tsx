        ...
        <>
            ...
            <ArticleSection title="Juego 1. Nivel 1.">
                ...
                <div className="flex justify-center my-6">
                    <Image 
                        src="/subitizacion/juego-puntos-1-3-desorden.jpeg" 
                        alt="Juego de tarjetas con puntos con cantidades del 1 al 3, para agrupar bajo tarjetas con los dígitos 1, 2 y 3" 
                        width={0} height={0} 
            ...
            <ArticleSection title="Dinámica">
                ...
                <div className="flex flex-row flex-wrap gap-3 md:gap-4 my-6 items-center justify-center">
                    ...
                    />
                    <Image 
                        src="/subitizacion/juego-puntos-1-3-orden.jpeg" 
                        alt="Juego de tarjetas con puntos con cantidades del 1 al 3, para agrupar bajo tarjetas con los dígitos 1, 2 y 3" 
                        width={0} height={0}
                        className="max-h-[400px] h-auto w-auto" 
                    />
