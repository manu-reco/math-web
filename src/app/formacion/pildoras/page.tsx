        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <h3 className={clsx("font-bold", isSelected ? "text-primary" : "text-gray-700")}>
                                                {saber.title}
                                            </h3>
                                            <p className="text-sm text-gray-500">{saber.description}</p>
                                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-secondary/10 text-secondary text-sm">2</span>
                            Elige un Nivel
                        </h2>
                        <div className="space-y-3">
                            {NIVELES.map((nivel) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <h3 className={clsx("font-bold", isSelected ? "text-secondary" : "text-gray-700")}>
                                                {nivel.title}
                                            </h3>
                                            <p className="text-sm text-gray-500">{nivel.description}</p>
                                        </div>
